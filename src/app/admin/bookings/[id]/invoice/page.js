...
export default function InvoicePage() {
    ...
    if (loading) return (
        <div className="flex flex-col items-center justify-center min-h-screen gap-6 bg-gradient-to-br from-slate-50 via-white to-amber-50/30">
            ...
            <p className="text-slate-600 font-semibold text-lg tracking-wide">Preparing your invoice...</p>
        </div>
    );
    ...
    if (!booking) return (
        <div className="min-h-screen flex items-center justify-center bg-gradient-to-br from-slate-50 to-red-50">
            <div className="text-center p-12 bg-white rounded-3xl shadow-2xl border border-red-100">
                ...
                <h3 className="text-2xl font-bold text-red-600 mb-2">Booking Not Found</h3>
                <p className="text-slate-600">The requested invoice could not be located.</p>
            </div>
        </div>
    );
    ...
    return (
        <div className="bg-gradient-to-br from-slate-50 via-white to-amber-50/20 min-h-screen py-10 print:py-0 print:bg-white">
            ...
            <div className="relative bg-white p-8 md:p-12 max-w-[850px] mx-auto text-slate-800 printable-area shadow-[0_20px_80px_-15px_rgba(0,0,0,0.15)] print:shadow-none rounded-2xl print:rounded-none border border-slate-100/50 print:border-0">
            ...
            <div className="fixed bottom-10 left-1/2 -translate-x-1/2 flex items-center gap-4 bg-white/95 backdrop-blur-xl p-5 rounded-3xl shadow-[0_20px_60px_-15px_rgba(0,0,0,0.3)] border border-slate-200/50 print:hidden z-50">
                <button
                    onClick={() => router.back()}
                    className="flex items-center gap-3 px-7 py-3.5 rounded-2xl font-bold text-sm uppercase tracking-wider text-slate-600 hover:text-slate-900 hover:bg-slate-100 transition-all duration-300 group"
                >
                ...
                <button
                    ...
                    className="flex items-center gap-3 px-8 py-3.5 bg-gradient-to-r from-slate-800 to-slate-900 text-white rounded-2xl font-bold text-sm uppercase tracking-wider hover:scale-105 active:scale-95 transition-all duration-300 shadow-xl shadow-slate-900/30 group"
                >
